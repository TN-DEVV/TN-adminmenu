local Translations = {
    error = {
        ...
        ["blips_name_anticheat"] = "ANTICHEAT: PLEASE REMOVE THE BLIPS AND NAMES BEFORE GOING OUTDUTY NEXT TIME !!!!",
        ["duty"] = "You need to be on duty"
    },
    success = {
        ...
        ["veh_upgrade"] = "your vehicle is full upgrade right now",
    },
    info = {
    ...
    commands = {
        ...
        ["bring"] = "Bring a player to you(only Admin)",
        ["bringback"] = "Bring back a player(only Admin)",
        ["bringall"] = "Bring all players to you(only admin)",
    },
    volume = {
